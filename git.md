...
Коммит - это запись об изменении состояния папки. Коммит содержит в себе полную информацию о состоянии всех файлов в папке, кроме служебных и игнорируемых. 
